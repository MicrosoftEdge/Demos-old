...
(function() {
	...
	var ui = {
		...
		bindEvents: function() {
			...
			$('#saved-list')
				...
				.on('click', '.button-delete', function(e) {
					...
					ui.confirm(ui.strings.confirm_delete).then(function(confirm) {
						if (!confirm) {
							return;
						}
		...
		getPermissionForUnsavedChanges: function() {
			audio.pause();
		...
		alert: function(str) {
			var diag = ui.createAndShowDiag(ui.strings.please_note, str);
		...
		confirm: function(str) {
			var diag = ui.createAndShowDiag(ui.strings.please_confirm, str);
		...
		createAndShowDiag: function(title, msg) {
