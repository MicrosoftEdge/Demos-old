(function () {
	...
	const createCredential = function () {
		try {
			...
			const attestationChallenge = new TextEncoderLite('utf-8').encode('Four score and seven years ago');
	...
	const verify = function () {
		...
		const challenge = new TextEncoderLite('utf-8').encode('Our fathers brought forth on this continent, a new nation');
