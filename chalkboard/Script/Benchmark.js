...
var cb = document.getElementById("Chalkboard"), ecb = document.getElementById("EmptyChalkboard"), intro = document.getElementById("Intro"), timer = document.getElementById("Timer"), results = document.getElementById("Results"), audio = document.getElementById("Audio");
