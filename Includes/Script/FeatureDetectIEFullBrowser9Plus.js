    ...
    self.$FeatureDetectIEFullBrowser9Plus = {
        ...
        test: function () {
            var pass =
                ...
                !$BrowserInfo.IsBrowserPlatformPreview() &&
                ($BrowserInfo.GetBrowserVersion() >= 9);
            ...
            if (!pass) {
                if (ppb) {
                    ...
                    $FeatureDetect.fail("This demo requires Internet Explorer 9 user interface features.", "fullie");
                }
            }
        }
    }
