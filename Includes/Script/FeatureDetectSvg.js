...
if(typeof($FeatureDetectSvg) == 'undefined')
{
    self.$FeatureDetectSvg = {
        ...
        test: function () {
            ...
            var svgSupported = document.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#Structure", "1.1")

            if (!svgSupported) {
                $FeatureDetect.fail("Your browser doesn't support HTML5 SVG.");
            }
        }
    }
